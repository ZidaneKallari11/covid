        ...
        <div class="container">
                ...
                <div class="col-md">
                    ...
                    <div class="card">
                     <div class="card-header">
                       <h2 class="card-title"><i class="fab fa-battle-net"></i>Pasien COVID-19</h2>
                     </div>
            ...
            <table class="table">
                <thead>
                    ...
                    <th scope="col">Tanggal Dirawat</th>
                ...
                <?php
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            {
                                echo '<h5><span class="badge badge-info">dirawat</span></h5>';
                            }else{
                                echo '<h5><span class="badge badge-secondary">sembuh</span></h5>';
                            }
                            ?>
                         </td>
                         <td>
